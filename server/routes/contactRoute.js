...
contactRouter.post('/', contactLimiter, async (req, res) => {
  try {
    ...
    // Email content
    const mailOptions = {
      from: `"Inovix" <${process.env.SENDER_EMAIL}>`,
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px;">
          ...
          <div style="margin-top: 30px; padding: 15px; background-color: #dbeafe; border-radius: 8px; text-align: center;">
            <p style="margin: 0; color: #1e40af; font-size: 14px;">
              This message was sent from the Inovix website contact form.
      ...
      `,
      text: `
You have received a new contact form message from the Inovix website:
